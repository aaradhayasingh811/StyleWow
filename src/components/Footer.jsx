        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">StyleWow</span>
            </div>
            <p className="mb-4">Your personal fashion assistant helping you discover perfect outfits for your unique style.</p>
            <div className="flex space-x-4">
              <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-pink-500 transition">
              ...
              <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-pink-500 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#why-us" className="hover:text-pink-500 transition">Why Choose Us</a></li>
              <li><a href="#subscription" className="hover:text-pink-500 transition">Pricing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-pink-500 transition">Refund Policy</a></li>
          ...
          <div>
            ...
            <p className="mb-4">Subscribe to get fashion tips and exclusive offers</p>
            <form 
              className="flex"
            ...
            >
              ...
              <button 
                type="submit" 
                className="bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-r-lg transition"
              >
